...
import com.mentor.impl.Download_Export_Order_SpiritImpl;

 

public class Download_Export_Order_SpiritAction {
	...
	Download_Export_Order_SpiritImpl impl = new Download_Export_Order_SpiritImpl();
	...
	public Download_Export_Order_SpiritDT getDt() {
		return dt;
	}

	public void setDt(Download_Export_Order_SpiritDT dt) {
		this.dt = dt;
	}
	...
	public void view(ActionEvent e) {
		...
		UIDataTable uiTable = (UIDataTable) e.getComponent().getParent()
				.getParent();
		Download_Export_Order_SpiritDT dt = (Download_Export_Order_SpiritDT) this.dataTable
