...
import com.mentor.impl.Replytoobjection_eoi_spiritImpl;
import com.mentor.utility.Constants;

public class Replytoobjection_eoi_spiritAction {

	
	Replytoobjection_eoi_spiritImpl impl = new Replytoobjection_eoi_spiritImpl();
	...
	public Replytoobjection_eoi_spiritImpl getImpl() {
		return impl;
	}

	public void setImpl(Replytoobjection_eoi_spiritImpl impl) {
		this.impl = impl;
	}
	...
	public void view(ActionEvent e)
	{
		...
		Replytoobjection_eoi_spiritDT dt = (Replytoobjection_eoi_spiritDT) this.objectionlist.get(uiTable.getRowIndex());
	...
	public void uploadFile(UploadEvent e) {
		try {
			...
			String pdfPath = mypath+ File.separator + "ExciseUp"  + File.separator + "ExportOutsideIndia" + File.separator + "SPIRIT"+ File.separator + "EOIOBJECTION";

			InputStream io = new FileInputStream(path);

			String recordFile = "SpiritEOIExportObjectionReply_"+this.appID+"_"+this.objectionID+".pdf";
