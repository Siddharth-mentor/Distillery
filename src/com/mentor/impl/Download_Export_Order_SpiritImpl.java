...
import com.mentor.Datatable.Download_Export_Order_SpiritDT;
import com.mentor.action.Download_Export_Order_SpiritAction;
import com.mentor.resource.ConnectionToDataBase;
import com.mentor.utility.ResourceUtil;
import com.mentor.utility.Utility;

public class Download_Export_Order_SpiritImpl {



	public void getDetails(Download_Export_Order_SpiritAction act){
		...
		try {
			...
			while (rs.next()) {
			 ...
			 System.out.println("===getDl_id===="+act.getDl_id());
	...
	/*public String getDetails(Download_Export_Order_SpiritAction ac) throws SQLException {
		int id = 0;
		Connection con = null;
	...
	public void update(Download_Export_Order_SpiritAction action){
		...
		try {
			...
			String query = " update distillery.eoi_app_for_export_order_spirit set "+
	...
	public ArrayList getdata(Download_Export_Order_SpiritAction act) {
		...
		try {
			...
			String show_query = 
					" SELECT b.app_id, a.seq_pk,b.created_date, a.po_number, a.po_date,a.importing_unit_nm ,"+
							...
							" from distillery.eoi_import_order_master_spirit a ,distillery.eoi_app_for_export_order_spirit b " +
							" where  " + filter + " " +
							" and b.order_id= a.seq_pk  and a.int_dist_id='"+act.getDl_id()+"' order by a.seq_pk ";

System.out.println("===show_query====="+show_query);
...

			{
				...
				Download_Export_Order_SpiritDT dt = new Download_Export_Order_SpiritDT();
