	...
	border: 1px solid #669999;
		...
		<h:form>
			<div class="container">
									...
									<TBODY>
										...
										<tr>
											<TD align="center" colspan="2"><h2>
													...
													<h:inputHidden value="#{replytoobjection_eoi_spiritAction .hidden}" />
												</h2></TD>
										</tr>
				...
				<div class="row" align="center">
					<div class="col-md-12">
						<rich:dataTable align="center" id="table1" rows="10" width="100%"
							var="list" value="#{replytoobjection_eoi_spiritAction.objectionlist}"
							...
							<rich:column>
								...
								<center>
									<h:commandButton styleClass="btn btn-primary btn-sm"
										actionListener="#{replytoobjection_eoi_spiritAction.view}"
				...
				<h:panelGroup rendered="#{replytoobjection_eoi_spiritAction .viewPanelFlg}">
					<div class="row" align="center" style="background-color: #e6ffff">
						<div class="col-md-12">
							<h:outputText
								value="Application No.:#{replytoobjection_eoi_spiritAction.appID} "
					...
					<div align="center" class="row">
						...
						<div class="col-md-3" align="left">
							<h:inputText readonly="true" style="width: 400px; height: 30px;"
								value="#{replytoobjection_eoi_spiritAction.title}" />
						</div>
						<div class="col-md-3" align="right">
							<b><h:outputText value="Objection Date :" /></b>
						</div>
						<div class="col-md-3" align="left">
							<rich:calendar value="#{replytoobjection_eoi_spiritAction.obj_date }"
								readonly="true" />
						</div>
					...
					<div class="col-md-12">
						...
						<div class="col-md-3" align="left">
							<rich:fileUpload clearControlLabel="clear"
								...
								fileUploadListener="#{replytoobjection_eoi_spiritAction.uploadFile}">
						...
						<div class="col-md-5 img-responsive" align="left">
							...
							<a4j:outputPanel id="renpdftrue2">
								<h:outputLink rendered="#{replytoobjection_eoi_spiritAction.doc2Flg}"
									target="_blank"
									value="/doc/ExciseUp/ExportOutsideIndia/SPIRIT/EOIOBJECTION/#{replytoobjection_eoi_spiritAction.viewFile}" style="FONT-SIZE: xx-small;">
							...
							<a4j:outputPanel id="renpdffalse2">
								<a4j:outputPanel rendered="#{!replytoobjection_eoi_spiritAction .doc2Flg}">
					...
					<div class="col-md-12">
						...
						<div class="col-md-7" align="left">
							<h:inputTextarea value="#{replytoobjection_eoi_spiritAction.fillComment}"
								styleClass="form-control"
					...
					<div class="row" align="center">
						...
						<h:commandButton value="Submit" styleClass="btn btn-success btn-sm"
							action="#{replytoobjection_eoi_spiritAction.save}" />
						<h:commandButton value="Close" styleClass="btn btn-warning btn-sm"
							action="#{replytoobjection_eoi_spiritAction.reset}" />
					</div>

				</h:panelGroup>
				<div class="row" align="center">
					<h:commandButton value="Back" styleClass="btn btn-secondary btn-sm"
						action="#{replytoobjection_eoi_spiritAction.back}" />
				</div>
			</div>
		</h:form>
	</f:view>
