	...
	<f:view>
		<h:form style="background-color:whitesmoke;">
			...
			<div class="form-group">
				...
				<div class="row">
					<div align="center">
						<h:outputText value="Download Spirit Export Order "
							style="COLOR: #0000a0; FONT-WEIGHT: bold; FONT-SIZE: 35px;font-family:Comic Sans MS;"></h:outputText>
					</div>
				</div>
				<h:inputHidden value="#{download_Export_Order_SpiritAction.hidden}"></h:inputHidden>
				<hr style="border-top: 7px #D0D3D4; border-top-style: dashed;"></hr>
				...
				<div class="row col-md-12" align="center"
					...
					<div class="col-md-12" align="center">
						<h:selectOneRadio
							...
							value="#{download_Export_Order_SpiritAction.radio}"						
             ...
             <div class="col-md-12" align="center">
					     ...
					     <rich:dataTable id="tableunit"
							...
							value="#{download_Export_Order_SpiritAction.dataTable}"
							rendered="#{download_Export_Order_SpiritAction.radio eq 'pfa'}"
							...
							<rich:column >
								...
								<h:commandButton value="Objection Reply"
											action="#{download_Export_Order_SpiritAction.replyObjection}"
											rendered="#{list.objection_reply_button}" 
											styleClass = "btn btn-sm btn-primary btn-sm" >
											<f:setPropertyActionListener value="#{list}"
														target="#{download_Export_Order_SpiritAction.dt}" />
			                    </h:commandButton>
							...
							<rich:dataTable id="tableunitH" rows="10"
								...
								<rich:column rendered="#{download_Export_Order_SpiritAction.radio ne 'pfa'}">
									<f:facet name="header">
								...
								<rich:column rendered="#{download_Export_Order_SpiritAction.radio eq 'DP'}">
									<f:facet name="header">
										<h:outputText value="Status"
											styleClass="generalHeaderOutputTable"
											style="FONT-WEIGHT: bold;"></h:outputText>
								...
								<rich:column rendered="#{download_Export_Order_SpiritAction.radio eq 'ms2'}">
									<f:facet name="header">
								...
								<rich:column align="center" rendered="#{download_Export_Order_SpiritAction.radio eq 'DP'}">
										<f:facet name="header">
							...
							target="_blank"
							value="/doc/ExciseUp/ExportOutsideIndia/SPIRIT/License/#{list2.pdfName}">
