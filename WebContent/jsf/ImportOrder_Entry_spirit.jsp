						...
						<div class="row">
							...
							<div class="col-md-4" align="left">
								...
								<h:inputText value="#{importOrderEntry_spirit_action.unit_nm}"
									style="FONT-FAMILY: 'Agency FB'; border-radius: 6px;padding: 5px 5px;height: 30px;width: 300px;box-shadow: 1px 1px 4px 4px gray;border: 1px solid #669999;">
							...
							<div class="col-md-1 img-responsive">
								<a4j:outputPanel id="renpdftrue1">
									<h:outputLink
										...
										target="_blank"
										value="/doc/ExciseUp/ImportOrderEntry/Spirit/ImportOrder/#{importOrderEntry_spirit_action.recordFile}">
					...
					<div style="overflow-y: scroll; height: 500px; align: center;">
						<rich:dataTable id="table2" width="98%" var="list"
							...
							<rich:column>
								...
								<h:outputLink
									value="/doc/ExciseUp/ImportOrderEntry/Spirit/#{list.orderCopy}"
									target="_blank">
